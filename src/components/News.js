...
const News=(props)=>{
 ...
 const updateNews=async()=>{
    ...
    props.setProgress(30)
      let url=`https://newsapi.org/v2/top-headlines?country=${props.country}&page=${page}&category=${props.category}&apiKey=${props.apiKey}&page=${page - 1}&pageSize=${props.pageSize}`;
  ...
  const fetchMoreData= async()=>{
    ...
    setPage(page+1)
      let url=`https://newsapi.org/v2/top-headlines?country=${props.country}&page=${page + 1}&category=${props.category}&apiKey=${props.apiKey}&page=${page - 1}&pageSize=${props.pageSize}`;
      fetch(url).then((response) => response.json())
      .then((data) => {
    ...
    return (
      ...
      <>
          <h1 className="text-center" style={{marginTop:70}}>Top Heading</h1>
